...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"""тhank you for adding me as your friend😉
...
☆ ༺༙ྈP̺͆⃗͛R̺͆⃗͛Ω͛L̺͆⃗͛I̺͆⃗͛Π͛G̺͆⃗͛  ੌ༙ྈT̺͆⃗͛Σ͛Δ͛M̺༙͆⃗͛ྈੌ ༙ྈβ͛Ω͛T̺༙͆⃗͛ྈ༻ ☆
    ...
    #-----------------=Selesai=------------------
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        random.choice(KAC).sendText(msg.to,"QR has been opened")
                    else:
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    random.choice(KAC).updateGroup(X)
                    if wait["lang"] == "JP":
                        random.choice(KAC).sendText(msg.to,"QR  is already closed")
                    else:
                ...
                #print wait2
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "|| 🤖Di Read Oleh🤖||%s\n||By : Team Sadistic BOT||\n\n>👉Pelaku CCTV👈<\n%s-=CCTV=-\n•Bintitan\n•Panuan\n•Kurapan\n•Kudisan\n Team Sadistis Bot Protect \n[%s]" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
...
#-----------------------------------------------
    ...
    #-------------Fungsi Tag All Finish---------------#
              ...
              if msg.from_ in owner:
                print "[Command]Like executed"
                cl.sendText(msg.to,"We Are Ready Like Friend Status")
                cl.sendText(msg.to,"Oke👌👌")
                try:
                  autolike()
                except:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                f=codecs.open('st2__b.json','w','utf-8')
                                json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                cl.sendText(msg.to,"Net account returned")
                            except:
...
#-----------------------------------------------
      ...
      #-------------Fungsi Bannlist Start------------------#          
              ...
              if msg.from_ in admin:
                if wait["blacklist"] == {}:
                    random.choice(KAC).sendText(msg.to,"No Account Expired")
                else:
...
#---------------------
        ...
        if op.type == 15:
          if op.param2 in Bots:
             return
          random.choice(KAC).sendText(op.param1, "Bye ..😑 ")
    ...
    for zx in range(0,500):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by :Team Sadistic\n\nAdd https://line.me/R/ti/p/%40ayu1654p")
          kk.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by :Team Sadistic\n\nAdd https://line.me/R/ti/p/%40ayu1654p")
          kc.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          kc.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by :Team Sadistic\n\nAdd https://line.me/R/ti/p/%40ayu1654p")
          ks.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          ks.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by :Team Sadistic\n\nAdd https://line.me/R/ti/p/%40ayu1654p")
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Suport by :===🍂༺༙ྈP̺͆⃗͛R̺͆⃗͛Ω͛L̺͆⃗͛I̺͆⃗͛Π͛G̺͆⃗͛  ੌ༙ྈT̺͆⃗͛Σ͛Δ͛M̺༙͆⃗͛ྈੌ ༙ྈβ͛Ω͛T̺༙͆⃗͛ྈ༻🍂===")
          print "Like"
        except:
          pass
      else:
